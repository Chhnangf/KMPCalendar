...
import org.example.charts.charts.internal.ANIMATION_TARGET
...
import org.example.charts.charts.internal.common.model.minMax
...
internal fun LineChart(
    ...
    val lineAnimation by animateFloatAsState(
        targetValue = if (show) org.example.charts.charts.internal.ANIMATION_TARGET else 0f,
    ...
    Canvas(modifier = style.modifier
        .testTag(org.example.charts.charts.internal.TestTags.LINE_CHART)
...
private fun DrawScope.drawChartPath(
    ...
    if (lineAnimationProgress == org.example.charts.charts.internal.ANIMATION_TARGET) {
        drawPath(
            path = path,
            color = lineColor,
...
private fun DrawScope.tryDrawPathPoints(
    ...
    for (i in values.indices) {
        if (lineAnimationProgress < org.example.charts.charts.internal.ANIMATION_TARGET) continue
